...
class install_plugins_test extends adler_testcase {
    ...
    public static function setUpBeforeClass(): void {
        ...
        self::$webserver_process = new Process(["php", "-S", "localhost:8080", $CFG->dirroot . "/local/adlersetup/tests/resources/install_plugins_github_mock_server/router.php"]);
        ...
        usleep(100);  // wait for the server to start.
    }
    ...
    public function test_install_and_update_plugin() {
        ...
        $play->github_api_url = 'http://localhost:8080';
        $play->play();
